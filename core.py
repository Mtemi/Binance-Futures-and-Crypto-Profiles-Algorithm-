...
class CoinMarketCap(object):
    ...
    market.coin_list()
    """
    __CMC_API_URL = u'https://pro-api.coinmarketcap.com/v1/'
    ...
    def coin_list(self, disable_cache=False):
        ...
        :return: json
        """
        response = self.client.request(self.__CMC_API_URL, u'exchange/listings/latest/', params=None, disable_cache=disable_cache)
        return response
